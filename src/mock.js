...
let templateAuthentication = {
  ...
  'role': {
    ...
    'id': 2,
    'level': 4,
    'menu': 'AdminSetting,AdminList,RoleList,RolePerm,LogList,Log_,ModeList,Mode_,SysSetting,SysInfo,SysRestart,Network,Storage,Backup,FaceGroup,Face,Group,TaskBatch,Task,Batch,Queue,My,All,AdminSetting,AdminList,RoleList,RolePerm,LogList,Log_,ModeList,Mode_,SysSetting,SysInfo,SysRestart,Network,Storage,FaceGroup,Face,Group,TaskBatch,Task,Batch,Queue,My,All,TaskResult',
